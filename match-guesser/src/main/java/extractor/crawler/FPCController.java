...
public class FPCController {
	...
	public static void main(String[] args) throws Exception {
		...
		EnvCrawlConfig envCrawlConfig = CrawlConfigFactory.createEnvCrawlConfig("/home/francesco/workspace/MatchGuesser/match-guesser/src/main/resources/footballPlayersCrawlerConfig.xml");
         ...
         */
        controller.start(FootballPlayersCrawler.class, envCrawlConfig.getThreads());
    }
